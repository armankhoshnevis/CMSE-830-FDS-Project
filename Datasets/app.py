...
from race_schedule_vis import (
    f1_circuit_world_map, 
    races_by_continent, 
    races_by_circuit, 
    races_by_country)

from constructor_standing_vis import (
...
from lap_time_vis import (load_lap_times_data, 
                          plot_driver_lap_times)

from pit_stop_vis import (
...
if eda_section == "Introduction":
    st.image("DALL·E 2024-10-10 19.04.45.webp", caption="AI-Generated Picture, DALL·E, 2024-10-10", use_column_width=True) 
    st.markdown("""
                ### Hello F1
